...
const checkStats = (player) => {
  return player.energyKcal !== null && player.energyKcal !== undefined &&
    player.carbohydrate !== null && player.carbohydrate !== undefined &&
    player.protein !== null && player.protein !== undefined &&
    player.fat !== null && player.fat !== undefined;
};
