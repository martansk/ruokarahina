      ...
      <div className="battle">
        ...
        <div className="winner-details">
          <div className="winner-text">
            Kumpikaan ei jaksanut taistella, vaan {player[0].name.fi} ja{' '}
            {player[1].name.fi} lähtivät yhdessä kaljalle.
          </div>
        </div>
  ...
  return (
    <div className="battle">
      ...
      <div className="winner-details">
        <div className="winner-text">
          <b>
            {Object.values(battle).at(-1).turn.attacker.fi} voitti taistelun!
          </b>
        </div>
      </div>
                ...
                {Object.entries(battle).map((entry) => {
                  ...
                  return (
                    <BattleLine
                      ...
                      turn={value.turn}
                      attacker={
                        value.turn.attacker.fi === value.player1.name.fi
                          ? value.player1
                          : value.player2
                      }
                      defender={
