      ...
      <div className="player-info">
        ...
        <table className="player-table">
          <tbody>
            <tr>
              <td>Energia:</td>
              <td>{Math.round(props.energyKcal * 10) / 10}</td>
            </tr>
            <tr>
              <td>Hiilihydraatit:</td>
              <td>{Math.round(props.carbohydrate * 10) / 10}</td>
            </tr>
            <tr>
              <td>Proteiinit:</td>
              <td>{Math.round(props.protein * 10) / 10}</td>
            </tr>
            <tr>
              <td>Rasva:</td>
              <td>{Math.round(props.fat * 10) / 10}</td>
            </tr>
          </tbody>
        </table>
